...
public class ChiliBushBlock extends SweetBerryBushBlock {
    ...
    protected ItemStack getCloneItemStack(LevelReader p_304655_, BlockPos p_57257_, BlockState p_57258_, boolean p_388022_) {
        return new ItemStack(ModItems.CHILI.get());
    }
    ...
    protected InteractionResult useWithoutItem(BlockState p_316134_, Level p_316429_, BlockPos p_316748_, Player p_316431_, BlockHitResult p_316474_) {
        ...
        if (i > 1) {
            ...
            popResource(p_316429_, p_316748_, new ItemStack(ModItems.CHILI.get(), j + (flag ? 1 : 0)));
            p_316429_.playSound(
    ...
    protected boolean mayPlaceOn(BlockState state, BlockGetter level, BlockPos pos) {
        return state.is(BlockTags.DIRT) || state.getBlock() instanceof net.minecraft.world.level.block.FarmBlock || state.is(Blocks.DECORATED_POT);
    }
}
