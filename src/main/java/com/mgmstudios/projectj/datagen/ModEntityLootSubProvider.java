        ...
        this.add(
                ...
                LootTable.lootTable()
                        ...
                        .withPool(
                                LootPool.lootPool()
                                        .setRolls(ConstantValue.exactly(1.0F))
                                        .add(LootItem.lootTableItem(ModItems.CHILI))
                                        .add(LootItem.lootTableItem(ModItems.MAIZE))
                                        .add(LootItem.lootTableItem(ModItems.RAW_JADE).apply(SmeltItemFunction.smelted().when(this.shouldSmeltLoot())))
