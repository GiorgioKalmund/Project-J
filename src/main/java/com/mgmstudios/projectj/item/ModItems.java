...
public class ModItems {
    ...
    public static final DeferredItem<Item> QUEST_BOOK = register("quest_book", (properties) -> new QuestBook("Ancient Codex", "Project J Team", createQuestBookPages(8), properties.stacksTo(1).rarity(Rarity.UNCOMMON)));
